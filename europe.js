document.addEventListener("DOMContentLoaded", () => {
  const countries = [
      "Portugal", "Spain", "Belgium", "Italy", "Belarus",
      "Poland", "Greece", "Finland", "Germany",
      "Swedish", "Norway", "Moldova", "Ukrainian","Croatia","Ireland","Austria",
      "Czechia","Slovakia","Hungary","Lithuanian","Latvia","Romania","Bulgaria",
      "Estonia","Luxembourg","France","Holland","Bosnia and Herzegovina",
      "Slovenia","Serbia","Kosovo","Macedonia","Albania"
  ];
